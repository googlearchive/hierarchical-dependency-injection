...
class ViewVillainsListComponent0 extends AppView<import1.VillainsListComponent> {
  ...
  ViewVillainsListComponent0(AppView<dynamic> parentView, int parentIndex) : super(import7.ViewType.component, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
...
AppView<import1.VillainsListComponent> viewFactory_VillainsListComponent0(AppView<dynamic> parentView, int parentIndex) {
...
class _ViewVillainsListComponent1 extends AppView<import1.VillainsListComponent> {
  ...
  var _expr_0;
  _ViewVillainsListComponent1(AppView<dynamic> parentView, int parentIndex) : super(import7.ViewType.embedded, {'\$implicit': null}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
...
AppView<import1.VillainsListComponent> viewFactory_VillainsListComponent1(AppView<dynamic> parentView, int parentIndex) {
...
class _ViewVillainsListComponentHost0 extends AppView<dynamic> {
  ...
  _ViewVillainsListComponentHost0(AppView<dynamic> parentView, int parentIndex) : super(import7.ViewType.host, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways);
  @override
  ComponentRef build() {
...
AppView viewFactory_VillainsListComponentHost0(AppView<dynamic> parentView, int parentIndex) {
