...
class ViewHeroesListComponent0 extends AppView<import1.HeroesListComponent> {
  ...
  ViewHeroesListComponent0(AppView<dynamic> parentView, int parentIndex) : super(import7.ViewType.component, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
...
AppView<import1.HeroesListComponent> viewFactory_HeroesListComponent0(AppView<dynamic> parentView, int parentIndex) {
...
class _ViewHeroesListComponent1 extends AppView<import1.HeroesListComponent> {
  ...
  var _expr_0;
  _ViewHeroesListComponent1(AppView<dynamic> parentView, int parentIndex) : super(import7.ViewType.embedded, {'\$implicit': null}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
...
AppView<import1.HeroesListComponent> viewFactory_HeroesListComponent1(AppView<dynamic> parentView, int parentIndex) {
...
class _ViewHeroesListComponent2 extends AppView<import1.HeroesListComponent> {
  ...
  var _expr_0;
  _ViewHeroesListComponent2(AppView<dynamic> parentView, int parentIndex) : super(import7.ViewType.embedded, {'\$implicit': null, 'index': null}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
    componentType = ViewHeroesListComponent0._renderType;
  }
  @override
  ComponentRef<import1.HeroesListComponent> build() {
...
AppView<import1.HeroesListComponent> viewFactory_HeroesListComponent2(AppView<dynamic> parentView, int parentIndex) {
...
class _ViewHeroesListComponentHost0 extends AppView<dynamic> {
  ...
  _ViewHeroesListComponentHost0(AppView<dynamic> parentView, int parentIndex) : super(import7.ViewType.host, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways);
  @override
  ComponentRef build() {
...
AppView viewFactory_HeroesListComponentHost0(AppView<dynamic> parentView, int parentIndex) {
